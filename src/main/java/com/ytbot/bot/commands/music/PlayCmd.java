 ...
 */
package com.ytbot.bot.commands.music;

import com.ytbot.bot.Bot;
import com.ytbot.bot.audio.AudioHandler;
import com.ytbot.bot.audio.QueuedTrack;
import com.ytbot.bot.commands.DJCommand;
import com.ytbot.bot.commands.MusicCommand;
import com.ytbot.bot.playlist.PlaylistLoader;
import com.ytbot.bot.utils.FormatUtil;
import com.ytbot.bot.z_extended.CommandExpander;
...
public class PlayCmd extends MusicCommand
{
        ...
        if(event.getArgs().isEmpty() && event.getMessage().getAttachments().isEmpty())
        {
            ...
            if(handler.getPlayer().getPlayingTrack()!=null && handler.getPlayer().isPaused())
            {
                if(DJCommand.checkDJPermission(event))
                {
                    ...
                    System.out.println("играет трек");
                }
                else
                    event.replyError("Only DJs can unpause the player!");
                return;
            }
            CommandExpander.trackInfo(handler.getPlayer().getPlayingTrack().getInfo());
    ...
    private class ResultHandler implements AudioLoadResultHandler
    {
        ...
        private void loadSingle(AudioTrack track, AudioPlaylist playlist)
        {
            ...
            //Отсюда достается трек
            CommandExpander.trackInfo(track.getInfo());
